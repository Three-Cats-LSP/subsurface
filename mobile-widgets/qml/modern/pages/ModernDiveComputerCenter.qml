...
Kirigami.ScrollablePage {
	...
	component RecentDeleteButton: ToolButton {
		required property int recentSlot
		Layout.preferredWidth: 22
		Layout.preferredHeight: 22
		padding: 0
		text: "×"
		font.pixelSize: 13
		Accessible.name: qsTr("Delete recent computer")
		ToolTip.visible: hovered
		ToolTip.text: qsTr("Delete recent computer")
		background: Rectangle {
			radius: 4
			color: parent.hovered || parent.down ? "#38212B" : "transparent"
		}
		contentItem: Text {
			text: parent.text
			color: "#D94B5B"
			...
			Components.ModernCard {
				...
				Flow {
					...
					RowLayout {
						...
						RecentDeleteButton { recentSlot: 2 }
					}
					RowLayout {
						...
						RecentDeleteButton { recentSlot: 3 }
					}
					RowLayout {
						...
						RecentDeleteButton { recentSlot: 4 }
					}
				}
			}
		}
