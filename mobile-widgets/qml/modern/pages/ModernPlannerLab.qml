...
Kirigami.ScrollablePage {
 ...
 SpinBox { from: 1; to: 150; value: Backend.planner_gflow; onValueModified: { Backend.planner_gflow = value; page.generatePlan() } }
 Label { text: qsTr("GF high"); color: tokens.textMuted; Layout.fillWidth: true }
 SpinBox { from: 1; to: 150; value: Backend.planner_gfhigh; onValueModified: { Backend.planner_gfhigh = value; page.generatePlan() } } }
 ...
 SpinBox { from: 0; to: 4; value: Backend.vpmb_conservatism; onValueModified: { Backend.vpmb_conservatism = value; page.generatePlan() } } }
 ...
 TextField { Layout.preferredWidth: 86; text: page.sacText(Backend.bottomsac); inputMethodHints: Qt.ImhFormattedNumbersOnly; onEditingFinished: { Backend.bottomsac = page.sacValue(text); page.generatePlan() } }
 Label { text: qsTr("Deco SAC (%1)").arg(page.sacUnit); color: tokens.textMuted; Layout.fillWidth: true }
 TextField { Layout.preferredWidth: 86; text: page.sacText(Backend.decosac); inputMethodHints: Qt.ImhFormattedNumbersOnly; onEditingFinished: { Backend.decosac = page.sacValue(text); page.generatePlan() } } }
 ...
 Button { text: qsTr("Save current profile"); enabled: presetName.text.trim().length > 0; onClicked: { page.savePreset(presetName.text); presetName.clear() } } }
 ...
 SpinBox { from: 1; to: 99; value: Backend.descrate; enabled: Backend.drop_stone_mode; onValueModified: { Backend.descrate = value; page.generatePlan() } } }
 ...
 SpinBox { from: 1; to: 99; value: Backend.ascrate75; onValueModified: { Backend.ascrate75 = value; page.generatePlan() } } }
 ...
 SpinBox { from: 1; to: 99; value: Backend.ascrate50; onValueModified: { Backend.ascrate50 = value; page.generatePlan() } } }
 ...
 SpinBox { from: 1; to: 99; value: Backend.ascratestops; onValueModified: { Backend.ascratestops = value; page.generatePlan() } } }
 ...
 SpinBox { from: 1; to: 99; value: Backend.ascratelast6m; onValueModified: { Backend.ascratelast6m = value; page.generatePlan() } } }
 ...
 SpinBox { from: 0; to: 4; value: Backend.min_switch_duration; onValueModified: { Backend.min_switch_duration = value; page.generatePlan() } } }
				RowLayout { Layout.fillWidth: true; Label { text: qsTr("Surface segment (min)"); color: tokens.textMuted; Layout.fillWidth: true }
 SpinBox { from: 0; to: 4; value: Backend.surface_segment; onValueModified: { Backend.surface_segment = value; page.generatePlan() } } }
 ...
 SpinBox { from: 160; to: 2000; stepSize: 50; value: Backend.default_setpoint; textFromValue: function(value) { return (value / 1000).toFixed(2) }; valueFromText: function(text) { return Math.round(Number(text) * 1000) }; onValueModified: { Backend.default_setpoint = value; page.generatePlan() } } }
		...
		Components.ModernCard {
			...
			GridLayout { Layout.fillWidth: true; columns: page.width >= 700 ? 2 : 1
				...
				TextField { Layout.fillWidth: true; text: manager.plannerAltitudeForSurfacePressure(page.surfacePressureBar).toFixed(0); inputMethodHints: Qt.ImhFormattedNumbersOnly; placeholderText: qsTr("Altitude (-500 to 12,000 m)"); onEditingFinished: { var altitude = Number(text); if (!isNaN(altitude) && altitude >= -500 && altitude <= 12000) { page.surfacePressureBar = manager.plannerSurfacePressureForAltitude(altitude); page.generatePlan() } } }
 ...
 SpinBox { from: 9000; to: 12000; value: page.customSalinity; onValueModified: { page.customSalinity = value; page.generatePlan() } } }
			}
 ...
 SpinBox { from: 0; to: Backend.pressure === Enums.BAR ? 400 : 6000; value: Backend.reserve_gas; onValueModified: { Backend.reserve_gas = value; page.generatePlan() } } }
		}
		Components.ModernCard {
			Layout.fillWidth: true
 ...
 SpinBox { visible: page.contingencyScenario !== 2; from: 1; to: 30; value: page.contingencyDelta; onValueModified: page.contingencyDelta = value }
 ComboBox { visible: page.contingencyScenario === 2; Layout.fillWidth: true; model: page.gasNames; currentIndex: page.contingencyGasIndex; onActivated: page.contingencyGasIndex = currentIndex }
 ...
 Button { visible: Qt.platform.os !== "android" && Qt.platform.os !== "ios"; text: qsTr("Save TXT"); onClicked: contingencyTextFolder.open() }
 Button { visible: Qt.platform.os !== "android" && Qt.platform.os !== "ios"; text: qsTr("Save PDF"); onClicked: contingencyPdfFolder.open() } }
			}
		}
		Components.ModernCard {
			Layout.fillWidth: true
 ...
 Button { text: qsTr("Add gas"); onClicked: page.addCylinder() } }
 ...
 Button { text: qsTr("Remove"); enabled: cylinders.count > 1; onClicked: { cylinders.remove(index); page.updateGasNames(); page.generatePlan() } } }
			} }
 ...
 Button { text: qsTr("Add segment"); onClicked: page.addSegment() } }
 ...
 Button { text: qsTr("Copy deco slate"); onClicked: manager.copyToClipboard(page.decoSlate()) }
 Button { visible: Qt.platform.os !== "android" && Qt.platform.os !== "ios"; text: qsTr("Save as TXT"); onClicked: plannerTextFolder.open() }
 Button { visible: Qt.platform.os !== "android" && Qt.platform.os !== "ios"; text: qsTr("Save as PDF"); onClicked: plannerPdfFolder.open() }
 Item { Layout.fillWidth: true }
 Button { text: qsTr("Save plan"); enabled: page.planSaveAllowed; onClicked: page.generatePlan(true, true) } }
 ...
 Button { text: qsTr("Copy package"); onClicked: manager.copyToClipboard(page.planPackage()) }
 Button { visible: Qt.platform.os !== "android" && Qt.platform.os !== "ios"; text: qsTr("Package TXT"); onClicked: planPackageTextFolder.open() }
 Button { visible: Qt.platform.os !== "android" && Qt.platform.os !== "ios"; text: qsTr("Package PDF"); onClicked: planPackagePdfFolder.open() } }
