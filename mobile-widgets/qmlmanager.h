...
public:
	...
	enum export_types {
		...
		EX_DIVE_SITES_XML,
		EX_DIVES_UDDF,
		EX_DIVES_CSV_DETAILS,
		EX_DIVES_CSV_SUMMARY,
		EX_DIVELOGS_DE,
		EX_DIVESHARE
	};
	Q_ENUM(export_types)
...
public slots:
	...
	void commitChanges(QString diveId, QString number, QString date, QString location, QString gps,
			   ...
			   QString diveGuide, QString tags, QString diveMode, QString weight, QString notes, QStringList startpressure,
			   QStringList endpressure, QStringList gasmix, QStringList usedCylinder, int rating, int visibility, QString visibilityDistance, QString state);
